...
def extract(y, sr):
    ...
    message['amp'] = rms
    message['t_amp'] = t
    message['avg_amp'] = avg_a
    message['std_amp'] = std_dev
    message['amp_change_temp'] = temp_change_a
    message['t_amp_change_temp'] = temp_t
    message['amp_cut_avg'] = a_cut_avg
    message['amp_cut_std'] = a_cut_std_dev
